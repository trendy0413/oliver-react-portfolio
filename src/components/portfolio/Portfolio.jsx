                ...
                {items.map((elem) => {
                    ...
                    return (
                        <motion.div
                            ...
                            <h3 className="portfolio__title">{title}<br/>{description}</h3>
                            <a href={url} target="_blank" rel="noreferrer" className="portfolio__button">
                                <RiLink className="portfolio__button-icon" />
                            </a>
                            {
                                repositoryUrl && <a href={repositoryUrl} target="_blank" rel="noreferrer" className="portfolio__github-button">
